...
2026-05-29 飞书会议纪要归档：自动生成的飞书纪要 GitHub Pages 页面。

English summary: 2026-05-29 Feishu Minutes archive, an auto-generated Feishu Minutes GitHub Pages site.

### Online Entry Points

- GitHub repository: https://github.com/siuserxiaowei/2026-05-29-feishu-minutes-obcnv833
- Live / GitHub Pages: https://siuserxiaowei.github.io/2026-05-29-feishu-minutes-obcnv833/
- Default branch: `main`
...
```bash
git clone https://github.com/siuserxiaowei/2026-05-29-feishu-minutes-obcnv833.git
cd 2026-05-29-feishu-minutes-obcnv833
```
...
- 妙记：https://vi8r050ecuz.feishu.cn/minutes/obcnv833h21823s4db899f1i
- 模板：wiki
- 页面：`docs/index.html`
